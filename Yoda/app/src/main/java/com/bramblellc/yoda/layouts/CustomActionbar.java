...
public class CustomActionbar extends RelativeLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        this.textColor = a.getInteger(R.styleable.CustomActionbar_android_textColor, getResources().getColor(R.color.white));
        ...
        this.setBackgroundColor(getResources().getColor(R.color.color3));
